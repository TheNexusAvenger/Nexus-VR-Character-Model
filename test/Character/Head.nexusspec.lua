...
NexusUnitTesting:RegisterUnitTest(HeadTest.new("GetNeckCFrame"):SetRun(function(self)
    ...
    self:AssertClose(self.CuT:GetNeckCFrame(CFrame.Angles(0,math.rad(70),0) * CFrame.new(0,2,1),0),CFrame.Angles(0,math.rad(70),0) * CFrame.new(0,1.25,1.5) * CFrame.Angles(0,math.rad(-60),0),0.01)
    self:AssertClose(self.CuT:GetNeckCFrame(CFrame.Angles(0,math.rad(-10),0) * CFrame.new(0,2,1),0),CFrame.Angles(0,math.rad(-10),0) * CFrame.new(0,1.25,1.5) * CFrame.Angles(0,math.rad(10),0),0.01)
    self:AssertClose(self.CuT:GetNeckCFrame(CFrame.Angles(0,math.rad(-70),0) * CFrame.new(0,2,1),0),CFrame.Angles(0,math.rad(-70),0) * CFrame.new(0,1.25,1.5) * CFrame.Angles(0,math.rad(60),0),0.01)
    self:AssertClose(self.CuT:GetNeckCFrame(CFrame.new(0,2,1),0),CFrame.new(0,1.25,1.5),0.01)
    ...
    self:AssertClose(self.CuT:GetNeckCFrame(CFrame.Angles(0,math.pi + math.rad(70),0) * CFrame.new(0,2,1),math.pi),CFrame.Angles(0,math.rad(250),0) * CFrame.new(0,1.25,1.5) * CFrame.Angles(0,math.rad(-240),0),0.01)
end))
